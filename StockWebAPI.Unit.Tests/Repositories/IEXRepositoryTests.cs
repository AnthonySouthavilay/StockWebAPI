...
namespace StockWebAPI.Unit.Tests.Repositories
{
    public class IEXRepositoryTests
    {
        ...
        public async Task GetCompanyInformation_ValidSymbol_ReturnsModelAsync()
        {
            ...
            string mockReturnedCompanyResponse = "{\"symbol\":\"AAPL\",\"companyName\":\"Apple Inc.\",\"exchange\":\"NASDAQ\",\"industry\":\"Telecommunications Equipment\",\"website\":\"http://www.apple.com\"," +
            ...
            mockMessageHandler = new MockMessageHandler(mockReturnedCompanyResponse, System.Net.HttpStatusCode.OK);
